 ...
 * @LastEditTime: 2022-01-24 23:14:36
...
- <a id="user_info">用户信息表 <font color="ffff00"> (user_info)</font></a>
  ...
  - |字段名称|类型|中文名称|是否可空|默认值|注释| 
    ...
    |user_passwd|varchar(200)|用户密码|N|||
  ...
  - 建表语句
    ...
    ```
  - 注：
    - 1、创建此表前要创建 [文件信息表](#file_info)、[角色表](#role_style)
...
- <a id="goods_info">商品信息表 <font color="ffff00"> (goods_info)</font></a>
  ...
  - |字段名称|类型|中文名称|是否可空|默认值|注释| 
    ...
    |goods_num|varchar(30)|商品唯一编号|N||唯一不重复|
...
- <a id="goods_format">规格信息表 <font color="ffff00"> (goods_format)</font></a>
  ...
  - |字段名称|类型|中文名称|是否可空|默认值|注释| 
    ...
    |fk_goods_num|varchar(30)|商品编号|N||商品信息表外键|
...
- <a id="relation_obj_file">关系对应表 <font color="ffff00"> (relation_obj_file)</font></a>
  - 表名：relation_obj_file
  - 描述：文件关系对应表
  - |字段名称|类型|中文名称|是否可空|默认值|注释| 
    |:----|:----|:----|:----|:----|:----|
    |relation_id|bigint(20)|主键id|N|||
    |obj_id|varchar(100)|归属主id|Y||其他表主键或者唯一的编号|
...
- <a id="criticism">评论表 <font color="ffff00"> (criticism)</font></a>

  - 表名：criticism
  - 描述：店铺信息表
  - |字段名称|类型|中文名称|是否可空|默认值|注释| 
    |:----|:----|:----|:----|:----|:----|
    |criticism_id|int|评论id|N|||
    |fk_goods_num|varchar(30)|商品编号|N||商品信息表外键|
    |fk_user_id|char(10)|用户id|N||外键,用户表主键|
    |content|varhar(600)|评论内容|N|||
    |parentId|int|父评论id|Y||默认没有||
    |date|datetime|创建时间|N|now()|||
    |spare1|varchar(10)|备用字段1|Y|||
    |spare2|varchar(50)|备用字段2|Y|||
    |spare3|varchar(100)|备用字段3|Y|||
